...
def go_repositories():
    ...
    go_repository(
        ...
        sum = "h1:pvbXjB/BRXZiO+/Erp5Pxr+lnhDCv5uxNxHh3FLGZ/g=",
        version = "v0.18.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:+kk0J2Qf6xd8a5rxcNpf80jwCF99KUWA7tpvctTWObc=",
        version = "v0.18.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:QIz2xFax8W5XQREoNcP/MHgnt4ClgfZ837Qx9yCeCzA=",
        version = "v0.18.5",
    )
    go_repository(
        name = "io_k8s_gengo",
    ...
    go_repository(
        ...
        sum = "h1:mGRE5L7cm2Uucp5LNxwEcf60apGotk/g0+awoZ0JnGg=",
        version = "v0.18.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:6VZw2h4iwEB4GwgQU3Jvcsm8l9+yReTrErAEK1k6AC4=",
        version = "v0.0.0-20200115044656-831fdb1e1868",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Wr2hTNFlrb9smNqTGCfJHd21F9j0rh3jzB8Pkn0h2RE=",
        version = "v0.18.5",
    )
    go_repository(
        name = "io_k8s_kubectl",
        ...
        sum = "h1:htctXnWqcF1VBkuzbWINqnwx/rM7byH9o2ZuHntlbJo=",
        version = "v0.18.5",
    )
    go_repository(
        name = "io_k8s_metrics",
        ...
        sum = "h1:Q2YSvV3x3Z20LviLqPTyCC7HmdOZ1ijuSxEyEMh/4nc=",
        version = "v0.18.5",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:23Iu+lDIOpLhRbBBwLyaVm1X30nhjahFrtC0Sc4krLI=",
        version = "v0.0.0-20200326152330-3fd9fa394658",
    )
    go_repository(
        ...
        sum = "h1:MjlSkQrMZAygwnUO3Jr52DRvPpqgl4seKlfTO9NZwXc=",
        version = "v0.0.0-20200422085536-f24cbf292bdd",
    )
    go_repository(
        ...
        sum = "h1:V4E6yt4XWiBEPKnJbs/E8pgUq9AjZqzQfsL3eeT84Qs=",
        version = "v0.0.0-20200211121458-5e3d6e570160",
    )
    go_repository(
                name = "org_golang_x_mod",
        build_file_generation = "on",
